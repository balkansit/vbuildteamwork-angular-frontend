...
export interface Role {
  ...
  name: string; // Role name (e.g., Admin, Cashier)
  tenant_id?: number; // FK to tenants table (for multi-shop SaaS)
...
export const dataRoleTableColumns: {
  ...
  { key: 'slug', header: 'Slug', headerIcon: 'fa fa-link' },
];
